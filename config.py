...
class TrainConfig:
    ...
    learning_rate: float = 0.001                      # 最大 div_factor * learn_rate
    div_factor: int = 50
    ...
    save_total_limit: int = 3                  # 训练过程中，最多保留多少个分数最好的模型文件
...
@dataclass
class SFTConfig:
    finetune_from_ckp_file = PROJECT_ROOT + '/model_save/pretrain/checkpoint-118500'
    tokenizer_dir: str = PROJECT_ROOT + '/model_save/'  # tokenizer一般和model权重放在同一个文件夹
